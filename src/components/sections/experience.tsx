...
const experiences = [
    {
        ...
        date: "2023 - Present",
        description: "Leading the core product team, improving performance by 40% and migrating legacy codebase to Next.js."
    },
    {
        company: "Creative Studio",
        role: "Full Stack Developer",
        date: "2021 - 2023",
        description: "Developed award-winning websites for clients using WebGL and advanced animation libraries."
    },
    {
        company: "Startup Inc",
        role: "Junior Developer",
        date: "2020 - 2021",
        description: "Collaborated on the MVP launch, handling both frontend UI and backend API integrations."
    }
]
