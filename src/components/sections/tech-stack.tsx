...
const technologies = [
    { name: "Frameworks", items: ["Next.js", "React", "Vue", "Svelte"], icon: Layout },
    { name: "Languages", items: ["TypeScript", "JavaScript", "Python", "Rust"], icon: Code2 },
    { name: "Styling", items: ["TailwindCSS", "CSS Modules", "Sass", "Framer Motion"], icon: Layers },
    { name: "Backend", items: ["Node.js", "Bun", "PostgreSQL", "Firebase"], icon: Database },
    { name: "Tools", items: ["Git", "Docker", "Figma", "VS Code"], icon: Terminal },
]
