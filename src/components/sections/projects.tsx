...
const projects = [
  {
    ...
    description:
      "A full-stack e-commerce solution with real-time inventory and payments.",
  ...
  },
  {
    title: "AI Dashboard",
    description:
      "Analytics dashboard powered by machine learning models for data visualization.",
  ...
  },
  {
    title: "Social Graph",
    description:
      "Social networking tool visualizing connections between users in 3D space.",
      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            A collection of projects exploring different technologies and design
            patterns.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="relative z-10 flex flex-wrap gap-2 mt-auto">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 text-xs font-medium rounded-full bg-background/40 backdrop-blur-sm border border-foreground/5"
                  >
                    {tag}
                  </span>
                ))}
