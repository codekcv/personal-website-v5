...
export function Hero() {
    ...
    return (
        <Section id="hero" className="flex items-center justify-center pt-32 pb-20 md:pt-40 md:pb-32">
            <div className="container px-4 md:px-6">
                ...
                >
                    ...
                    <motion.p variants={item} className="text-xl md:text-2xl text-muted-foreground max-w-2xl leading-relaxed">
                        I craft digital experiences that merge art with code.
                        Building seamless, accessible, and performant web applications with modern technologies.
                    </motion.p>
